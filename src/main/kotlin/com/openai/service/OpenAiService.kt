...
class OpenAiService(
    ...
    fun uploadFile(fileRequestDto: FileRequestDto): ResponseEntity<Any> {
        return try {
            val uploadResult = openAiFeignClient.uploadFile(fileRequestDto.file, fileRequestDto.purpose)
